...
WIN_MELODY = [
    # Offenbach Can-Can / Infernal Galop hook, adapted for monophonic buzzer.
    n("5", 0.50), n("5", 0.50), n("5", 0.50), n("5", 0.50),
    n("5", 0.25), n("2", 0.25), n("2", 0.25), n("3", 0.25),
    n("2", 0.25), n("1", 0.25), n("1", 0.25), n("3", 0.25),
    n("4", 0.25), n("4", 0.25), n("6", 0.25), n("H1", 0.25),
    n("6", 0.25), n("5", 0.25), n("5", 0.50),
    n("6", 0.25), n("7", 0.25), n("7", 0.25), n("6", 0.25),
    n("5", 0.25), n("1", 0.25), n("1", 0.25), n("3", 0.25),
    n("3", 0.25), n("2", 0.25), n("3", 0.25), n("2", 0.25),
    n("3", 0.25), n("2", 0.25), n("3", 0.25), n("2", 0.25),
    n("3", 0.50), n("1", 0.50), n("L6", 0.50), n("L5", 0.50),
    n("L5", 0.25), n("2", 0.25), n("3", 0.25), n("4", 0.25),
    n("3", 0.25), n("2", 0.25), n("1", 0.50),
    n("3", 0.50), n("1", 0.50), n("L6", 0.50), n("L5", 0.50),
    n("7", 0.25), n("5", 0.25), n("6", 0.25), n("7", 0.25),
    n("H1", 0.50), n("H1", 0.50),
    n("H1", 0.25), n("5", 0.25), n("7", 0.25), n("5", 0.25),
    n("H1", 0.25), n("5", 0.25), n("7", 0.25), n("5", 0.25),
    n("H1", 0.25), n("H1", 0.25), n("H1", 0.25), n("H1", 0.25),
    n("H1", 0.25), n("H1", 0.25), n("H1", 0.25), n("H1", 0.25),
    n("H2", 0.25), n("H1", 0.25), n("7", 0.25), n("6", 0.25),
    n("5", 0.50), n("REST", 0.25),
    n("5", 0.25), n("6", 0.25), n("7", 0.25), n("H1", 0.25),
    n("H2", 0.25), n("H1", 0.25), n("7", 0.25), n("6", 0.25),
    n("5", 1.00),
]

FAIL_MELODY = [
    # Super Mario-style death/game-over jingle contour, using absolute notes so
    # the chromatic fall is not forced through the background-song scale.
    n("C5", 0.50), n("G4", 0.50), n("E4", 0.50),
    n("A4", 0.35), n("B4", 0.35), n("AS4", 0.35), n("A4", 0.35),
    n("G4", 0.50), n("REST", 0.25),
    n("E5", 0.35), n("G5", 0.35), n("A5", 0.50),
    n("F5", 0.35), n("G5", 0.35), n("E5", 0.50),
    n("C5", 0.35), n("D5", 0.35), n("B4", 1.00), n("REST", 0.50),
]
...
// divider. Background is See You Again; win is a Can-Can victory cue; fail is a
// Mario-style game-over cue.
module buzzer_note_player #(
    ...
    localparam int UNIT_CYCLES = CLK_HZ * 60 / (TEMPO_BPM * 4);
                ...
                unique case (play_mode)
                    ...
                    MODE_SONG: begin
                        if (collision_start_i && (active_song == SONG_BACKGROUND)) begin
                            ...
                            if (current_note == NOTE_REST) begin
                                beep_o <= 1'b0;
                                tone_cnt <= '0;
...
def render(path: Path, melody: list[tuple[str, int]]) -> None:
    ...
    for note, units in melody:
        frames.extend(square_tone(NOTE_HZ[note], UNIT_S * units))
